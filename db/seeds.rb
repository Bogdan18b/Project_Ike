...
b1.pictures.purge
byebug
photo1 = open('https://s3.amazonaws.com/project-ike-seeding-dev/avra1.jpg')
# photo2 = open('https://s3.amazonaws.com/project-ike-seeding-dev/avra2.jpg')
# photo3 = open('https://s3.amazonaws.com/project-ike-seeding-dev/avra3.jpg')
b1.pictures.attach(io: photo1, filename: 'avra1.jpg', content_type: 'image/jpg')
# b1.pictures.attach(io: photo2, filename: 'avra2.jpg')
# b1.pictures.attach(io: photo3, filename: 'avra3.jpg')
b1.save!
...
# b2.pictures.attach(io: photo4, filename: 'numpang1.jpg')
# b2.pictures.attach(io: photo5, filename: 'numpang2.jpg')
# b2.pictures.attach(io: photo6, filename: 'numpang3.jpg')
# b2.save!
...
# b3.pictures.attach(io: photo7, filename: 'bb1.jpg')
# b3.pictures.attach(io: photo8, filename: 'bb2.jpg')
# b3.pictures.attach(io: photo9, filename: 'bb3.jpg')
# b3.save!
...
# b4.pictures.attach(io: photo10, filename: 'bh1.jpg')
# b4.pictures.attach(io: photo11, filename: 'bh2.jpg')
# b4.pictures.attach(io: photo12, filename: 'bh3.jpg')
# b4.save!
...
# b5.pictures.attach(io: photo13, filename: 'bose1.jpg')
# b5.pictures.attach(io: photo14, filename: 'bose2.jpg')
# b5.pictures.attach(io: photo15, filename: 'bose3.jpg')
# b5.save!
...
# b6.pictures.attach(io: photo16, filename: 'singer1.jpg')
# b6.pictures.attach(io: photo17, filename: 'singer2.jpg')
# b6.pictures.attach(io: photo18, filename: 'singer3.jpg')
# b6.save!
...
# b7.pictures.attach(io: photo19, filename: 'data1.jpg')
# b7.pictures.attach(io: photo20, filename: 'data2.jpg')
# b7.pictures.attach(io: photo21, filename: 'data3.jpg')
# b7.save!
...
# b8.pictures.attach(io: photo22, filename: 'hardware1.jpg')
# b8.pictures.attach(io: photo23, filename: 'hardware2.jpg')
# b8.pictures.attach(io: photo24, filename: 'hardware3.jpg')
# b8.save!
...
# b9.pictures.attach(io: photo25, filename: 'hardcorp1.jpg')
# b9.pictures.attach(io: photo26, filename: 'hardcorp2.jpg')
# b9.pictures.attach(io: photo27, filename: 'hardcorp3.jpg')
# b9.save!
...
# b10.pictures.attach(io: photo28, filename: 'schem1.jpg')
# b10.pictures.attach(io: photo29, filename: 'schem2.jpg')
# b10.pictures.attach(io: photo30, filename: 'schem3.jpg')
# b10.save!
...
# b11.pictures.attach(io: photo28, filename: 'homed1.jpg')
# b11.pictures.attach(io: photo29, filename: 'homed2.jpg')
# b11.pictures.attach(io: photo30, filename: 'homed3.jpg')
# b11.save!
...
# b12.pictures.attach(io: photo31, filename: 'adco1.jpg')
# b12.pictures.attach(io: photo32, filename: 'adco2.jpg')
# b12.pictures.attach(io: photo33, filename: 'adco3.jpg')
# b12.save!
...
# b13.pictures.attach(io: photo34, filename: 'mid1.jpg')
# b13.pictures.attach(io: photo35, filename: 'mid2.jpg')
# b13.pictures.attach(io: photo36, filename: 'mid3.jpg')
# b13.save!
...
# b14.pictures.attach(io: photo37, filename: 'blink1.jpg')
# b14.pictures.attach(io: photo38, filename: 'blink2.jpg')
# b14.pictures.attach(io: photo39, filename: 'blink3.jpg')
# b14.save!
...
# b15.pictures.attach(io: photo37, filename: 'ludlow1.jpg')
# b15.pictures.attach(io: photo38, filename: 'ludlow2.jpg')
# b15.pictures.attach(io: photo39, filename: 'ludlow3.jpg')
# b15.save!
...
# b16.pictures.attach(io: photo40, filename: 'inform1.jpg')
# b16.pictures.attach(io: photo41, filename: 'inform2.jpg')
# b16.pictures.attach(io: photo42, filename: 'inform3.jpg')
# b16.save!
...
# b17.pictures.attach(io: photo43, filename: 'nerai1.jpg')
# b17.pictures.attach(io: photo44, filename: 'nerai2.jpg')
# b17.pictures.attach(io: photo45, filename: 'nerai3.jpg')
# b17.save!
...
# b18.pictures.attach(io: photo46, filename: 'phyt1.jpg')
# b18.pictures.attach(io: photo47, filename: 'phyt2.jpg')
# b18.pictures.attach(io: photo48, filename: 'phyt3.jpg')
# b18.save!
...
# b19.pictures.attach(io: photo49, filename: 'allora1.jpg')
# b19.pictures.attach(io: photo50, filename: 'allora2.jpg')
# b19.pictures.attach(io: photo51, filename: 'allora3.jpg')
# b19.save!
...
# b20.pictures.attach(io: photo52, filename: 'seafire1.jpg')
# b20.pictures.attach(io: photo53, filename: 'seafire2.jpg')
# b20.pictures.attach(io: photo54, filename: 'seafire3.jpg')
# b20.save!
...
# b21.pictures.attach(io: photo55, filename: 'amelie1.jpg')
# b21.pictures.attach(io: photo56, filename: 'amelie2.jpg')
# b21.pictures.attach(io: photo57, filename: 'amelie3.jpg')
# b21.save!
...
# b22.pictures.attach(io: photo58, filename: 'havana1.jpg')
# b22.pictures.attach(io: photo59, filename: 'havana2.jpg')
# b22.pictures.attach(io: photo60, filename: 'havana3.jpg')
# b22.save!
...
# b23.pictures.attach(io: photo61, filename: 'ocean1.jpg')
# b23.pictures.attach(io: photo62, filename: 'ocean2.jpg')
# b23.pictures.attach(io: photo63, filename: 'ocean3.jpg')
# b23.save!
...
# b24.pictures.attach(io: photo64, filename: 'pierre1.jpg')
# b24.pictures.attach(io: photo65, filename: 'pierre2.jpg')
# b24.pictures.attach(io: photo66, filename: 'pierre3.jpg')
# b24.save!
...
# b25.pictures.attach(io: photo67, filename: 'buenos1.jpg')
# b25.pictures.attach(io: photo68, filename: 'buenos2.jpg')
# b25.pictures.attach(io: photo69, filename: 'buenos3.jpg')
# b25.save!
...
# b26.pictures.attach(io: photo70, filename: 'nonsolo1.jpg')
# b26.pictures.attach(io: photo71, filename: 'nonsolo2.jpg')
# b26.pictures.attach(io: photo72, filename: 'nonsolo3.jpg')
# b26.save!
...
# b27.pictures.attach(io: photo73, filename: 'blue1.jpg')
# b27.pictures.attach(io: photo74, filename: 'blue2.jpg')
# b27.pictures.attach(io: photo75, filename: 'blue3.jpg')
# b27.save!
...
# b28.pictures.attach(io: photo76, filename: 'whiskers1.jpg')
# b28.pictures.attach(io: photo77, filename: 'whiskers2.jpg')
# b28.pictures.attach(io: photo78, filename: 'whiskers3.jpg')
# b28.save!
...
# b29.pictures.attach(io: photo79, filename: 'brats1.jpg')
# b29.pictures.attach(io: photo80, filename: 'brats2.jpg')
# b29.pictures.attach(io: photo81, filename: 'brats3.jpg')
# b29.save!
...
# b30.pictures.attach(io: photo82, filename: 'pets1.jpg')
# b30.pictures.attach(io: photo83, filename: 'pets2.jpg')
# b30.pictures.attach(io: photo84, filename: 'pets3.jpg')
# b30.save!
...
# b31.pictures.attach(io: photo82, filename: 'petsh1.jpg')
# b31.pictures.attach(io: photo83, filename: 'petsh2.jpg')
# b31.pictures.attach(io: photo84, filename: 'petsh3.jpg')
# b31.save!
...
# b32.pictures.attach(io: photo85, filename: 'paws1.jpg')
# b32.pictures.attach(io: photo86, filename: 'paws2.jpg')
# b32.pictures.attach(io: photo87, filename: 'paws3.jpg')
# b32.save!
...
# b33.pictures.attach(io: photo88, filename: 'petro1.jpg')
# b33.pictures.attach(io: photo89, filename: 'petro2.jpg')
# b33.pictures.attach(io: photo90, filename: 'petro3.jpg')
# b33.save!
...
# b34.pictures.attach(io: photo91, filename: 'gard1.jpg')
# b34.pictures.attach(io: photo92, filename: 'gard2.jpg')
# b34.pictures.attach(io: photo93, filename: 'gard3.jpg')
# b34.save!
...
# b35.pictures.attach(io: photo94, filename: 'studio1.jpg')
# b35.pictures.attach(io: photo95, filename: 'studio2.jpg')
# b35.pictures.attach(io: photo96, filename: 'studio3.jpg')
# b35.save!
...
# b36.pictures.attach(io: photo97, filename: 'hair1.jpg')
# b36.pictures.attach(io: photo98, filename: 'hair2.jpg')
# b36.pictures.attach(io: photo99, filename: 'hair3.jpg')
# b36.save!
...
# b37.pictures.attach(io: photo100, filename: 'bianchi1.jpg')
# b37.pictures.attach(io: photo101, filename: 'bianchi2.jpg')
# b37.pictures.attach(io: photo102, filename: 'bianchi3.jpg')
# b37.save!
...
# b38.pictures.attach(io: photo103, filename: 'fox1.jpg')
# b38.pictures.attach(io: photo104, filename: 'fox2.jpg')
# b38.pictures.attach(io: photo105, filename: 'fox3.jpg')
# b38.save!
